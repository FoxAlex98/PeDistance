namespace GtaVModPeDistance.Models
{
    class Data
    {
        ...
        public Data(double distance, Ped2DBoundingBox boundingBox, string imageName, string b64File, string dayTime, float pedRotation, float cameraHeightFromGround)
        {
            Distance = distance;
